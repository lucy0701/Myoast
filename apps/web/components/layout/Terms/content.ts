...
제 1 조 (목적)
이 약관은 묘스트(이하 "회사")에서 제공하는 심리테스트 서비스(이하 "묘스트"이라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.
...
다. 기타 관계법령에서 정한 절차에따라 요청이 있는 경우

③ 사이트는 이 약관에서 정한 바에 따라 지속적이고 안정적으로 서비스를 제공할 의무가 있습니다.
...
제 13 조 (계약사항의 해지)
회원은 서비스 이용계약을 해지할 수 있으며, 해지할 경우에는 본인이 직접 서비스를 통하거나 전화 또는 온라인 등으로 사이트에 해지신청을 하여야 합니다. 사이트는 해지신청이 접수된 당일부터 해당 회원의 서비스 이용을 제한합니다. 사이트는 회원이 다음 각 항의 1에 해당하여 이용계약을 해지하고자 할 경우에는 해지조치 7일 전까지 그 뜻을 이용고객에게 통지하여 소명할 기회를 주어야 합니다.
...
[부칙]
(시행일) 이 약관은 2023년 07월 06일부터 시행합니다.
`;
